    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="hero-unit center" id="body">
                <h3>Alterar Dados de Endereço</h3>
                <form action="ControlerSetEnderecoLocation" method="POST" id="register-form" novalidate="novalidate">
                    <div class="fieldgroup">
                        ...
                        <input  class="span7"type="text" name="rua" id="rua" value="${usuario.endereco.rua}"  />
                    </div>

                    <div class="fieldgroup">
                        <label class="right">Cidade:</label>
                        <input class="span7"type="text" name="cidade" value="${usuario.endereco.cidade}" />
                    </div>
                    <div class="fieldgroup">
                        <label class="right">Nº:</label>
                        <input  class="span1"type="text" name="n" value="${usuario.endereco.numero}" />
                    </div>
                    <div class="fieldgroup">
                        <label class="right">Estado:</label>
                        <input class="span2"type="text" name="estado" value="${usuario.endereco.uf}" />
                    </div>
                    <div class="fieldgroup">
                        <label class="right">Cep:</label>
                        <input class="span2" type="text" name="cep" value="${usuario.endereco.cep}" id="cep"/><br />
                    </div>
